...
export const ContentCard = ({
	...
	return (
		<CardContainer>
			{header && (
				<div className="rounded-t-xl border-b bg-gray-100 dark:bg-gray-900 px-4 py-3 sm:px-5 md:py-4">
			...
			{footer && (
				<div className="rounded-b-xl border-t bg-gray-100 dark:bg-gray-900 px-4 py-3 sm:px-5 md:py-4">
